...
export default function SubtitleTab() {
  ...
  const generatePreviewStyle = () => ({
    ...
    backgroundColor: subtitleSettings.useBackground 
      ? `${subtitleSettings.backgroundColor}${Math.round(subtitleSettings.backgroundOpacity * 2.55).toString(16).padStart(2, '0')}`
      : 'transparent',
    border: subtitleSettings.useOutline 
      ? `${subtitleSettings.outlineWidth}px solid ${subtitleSettings.outlineColor}`
      : 'none',
  ...
  return (
    <div className={containerStyles.container}>
      ...
      <Card style={{ marginBottom: "32px" }}>
        <CardHeader
          header={<Title2>🎬 실제 영상 미리보기</Title2>}
          description="실제 영상에서 자막이 어떻게 표시되는지 확인하세요"
        />
        ...
        <div style={{ padding: "20px" }}>
          <div 
            ...
            style={{
              ...
              position: "relative",
              display: "flex",
              alignItems: subtitleSettings.position === "center" ? "center" : subtitleSettings.position === "top" ? "flex-start" : "flex-end",
          ...
          >
            ...
            <div 
              style={{
                ...
                position: "absolute",
                bottom: subtitleSettings.position === "bottom" ? `${Math.round(subtitleSettings.verticalPadding * 0.25) - Math.round((subtitleSettings.finePositionOffset || 0) * 0.25)}px` : "auto",
                top: subtitleSettings.position === "top" ? `${Math.round(subtitleSettings.verticalPadding * 0.25) + Math.round((subtitleSettings.finePositionOffset || 0) * 0.25)}px` : 
                      subtitleSettings.position === "center" ? `${180 + Math.round((subtitleSettings.finePositionOffset || 0) * 0.25)}px` : "auto",
                left: "50%",
                ...
                lineHeight: subtitleSettings.lineHeight,
                maxWidth: `${subtitleSettings.maxWidth}%`,
                padding: `${Math.round(subtitleSettings.verticalPadding * 0.12)}px ${Math.round(subtitleSettings.horizontalPadding * 0.25)}px`,
                ...
                border: subtitleSettings.useOutline 
                  ...
                  : 'none',
                textShadow: subtitleSettings.useShadow 
                  ? `${Math.round(subtitleSettings.shadowOffset * 0.25)}px ${Math.round(subtitleSettings.shadowOffset * 0.25)}px ${Math.round(subtitleSettings.shadowBlur * 0.25)}px ${subtitleSettings.shadowColor}`
                  : 'none',
              }}
            >
              안녕하세요! 웨이버 프로입니다.<br />
              이 영상에서는 AI로 콘텐츠를 제작하는 방법을 알아보겠습니다.
            </div>
          </div>
