...
import { ArrowLeft24Regular, Checkmark24Filled, DocumentBulletList24Regular, MusicNote224Regular, LightbulbFilament24Regular, ArrowDownload24Regular } from "@fluentui/react-icons";
        ...
        >
          ...
          <div style={{ marginLeft: tokens.spacingHorizontalM, marginBottom: tokens.spacingVerticalM }}>
            <Text size={200} style={{ display: "block", color: tokens.colorNeutralForeground2, marginBottom: 2 }}>
              1. <strong>미디어 편집</strong> 탭에서 키워드로 이미지/비디오를 검색하고 다운로드하세요
            </Text>
            <Text size={200} style={{ display: "block", color: tokens.colorNeutralForeground2, marginBottom: 2 }}>
              2. <strong>비디오 조립</strong> 탭에서 자막과 미디어를 조합하여 최종 영상을 생성하세요
            </Text>
            <Text size={200} style={{ display: "block", color: tokens.colorNeutralForeground2 }}>
              3. <strong>미디어 다운로드</strong> 탭에서 완성된 영상을 확인하고 내보내세요
            </Text>
          </div>
          <Button
            appearance="primary"
