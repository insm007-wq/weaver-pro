      ...
      <Card className={styles.card}>
        ...
        <div className={styles.termsContent}>
          <div className={styles.section}>
            ...
            <Text>
              본 약관은 주식회사 빌드비(이하 "회사")가 제공하는 Weaver Pro 소프트웨어(이하 "서비스")의
              이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항을 규정합니다.
            </Text>
          </div>
          ...
          <div className={styles.section}>
            ...
            <Text>
              본 약관은 회사가 제공하는 AI 기반 영상 제작 서비스의 이용조건 및 절차,
          ...
          <div className={styles.section}>
            ...
            <Text as="div">
              1. "서비스"란 Weaver Pro 소프트웨어를 통해 제공되는 AI 영상 제작 도구를 의미합니다.<br/>
              2. "이용자"란 본 약관에 따라 회사가 제공하는 서비스를 이용하는 자를 의미합니다.<br/>
          ...
          <div className={styles.section}>
            ...
            <Text as="div">
              ...
              1. 타인의 지적재산권을 침해하는 콘텐츠 생성<br/>
              2. 불법적이거나 유해한 콘텐츠 제작<br/>
              3. 서비스의 정상적인 운영을 방해하는 행위<br/>
          ...
          <div className={styles.section}>
            ...
            <Text>
              ...
              개인정보의 수집, 이용, 제공 등은 별도의 개인정보 처리방침에 따릅니다.
            </Text>
          </div>

          <div className={styles.section}>
            <div className={styles.sectionTitle}>제6조 (API 키 관리)</div>
            <Text>
              1. 이용자는 외부 AI 서비스 이용을 위해 자신의 API 키를 등록할 수 있습니다.<br/>
              2. API 키는 이용자의 로컬 환경에서 암호화되어 저장되며, 회사는 이를 수집하지 않습니다.<br/>
              3. API 키 사용에 따른 비용은 이용자가 부담합니다.
            </Text>
          </div>

          <div className={styles.section}>
            <div className={styles.sectionTitle}>제7조 (콘텐츠의 저작권)</div>
            <Text>
              1. 이용자가 서비스를 통해 생성한 콘텐츠의 저작권은 이용자에게 귀속됩니다.<br/>
              2. 단, AI가 생성한 콘텐츠의 경우 각 AI 서비스 제공자의 약관을 따릅니다.
            </Text>
          </div>

          <div className={styles.section}>
            <div className={styles.sectionTitle}>제8조 (면책조항)</div>
            <Text>
              1. 회사는 천재지변, 시스템 장애 등 불가항력적 사유로 서비스를 제공할 수 없는 경우 책임이 면제됩니다.<br/>
              2. 회사는 이용자가 생성한 콘텐츠의 적법성, 정확성에 대해 책임지지 않습니다.<br/>
              3. 회사는 외부 API 서비스의 장애 또는 중단에 대해 책임지지 않습니다.
            </Text>
          </div>

          <div className={styles.section}>
            <div className={styles.sectionTitle}>제9조 (약관의 변경)</div>
            <Text>
              회사는 필요한 경우 본 약관을 변경할 수 있으며, 변경된 약관은 서비스 내 공지를 통해 고지됩니다.
            </Text>
          </div>

          <div className={styles.section}>
            <div className={styles.sectionTitle}>제10조 (문의 및 분쟁 해결)</div>
            <Text>
              서비스 이용과 관련한 문의사항이나 분쟁이 발생한 경우,
              회사의 고객지원 채널을 통해 해결할 수 있습니다.
            </Text>
          </div>
        ...
        <div className={styles.footer}>
          <Text size={200}>
            © 2025 주식회사 빌드비 (BuildB Co., Ltd.) All rights reserved.
          </Text>
        </div>
      </Card>
    </div>
